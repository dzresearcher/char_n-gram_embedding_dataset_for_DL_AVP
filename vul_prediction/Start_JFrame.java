...
public class Start_JFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        DL_jButton.setText("DL-based vul detection");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(DL_jButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(94, 94, 94)
                .addComponent(DL_jButton, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) throws Exception {
        ...
        {
            /* command line form  : java -Xmx2048m -jar ./ZM_Vul_Prediction3.jar [DNN model: MLP/LSTM][HL:n1,n2,n3] [numepoch : 100] [dataset:file.arf] 
            examples :
            java -Xmx2048m -jar ./ZM_Vul_Prediction3.jar MLP 128,64,32 500 fc.arff     
            */
            String DNN_Model = args[0];
            String HiddenLayer = args[1];
            String Epochs = args[2];
            String Dataset_File_Name = args[3];
            int Num_Folds = 3;
            ...
            if ("MLP".equals(DNN_Model))
            {
                String Options = "-L 0.01 -M 0.01 -N "+ Epochs + " -V 0 -S 0 -E 20 -batch-size 128 -H " + HiddenLayer;               
            ...
            else if ("LSTM".equals(DNN_Model))
            {
                String Train_Dataset_File_Name = Dataset_File_Name;
                String Options = "L1:0.01 L2:0.01 N:"+Epochs+" DL:64 LSTML:"+HiddenLayer;
                boolean Balance_Dataset = false;
